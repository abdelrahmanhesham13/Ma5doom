...
import sma.tech.ma5doom.model.rate.BaseReview;
...
public class ShowRatingDialog extends AppCompatDialogFragment {
    @Override
    ...
    private void loadData(){
        ...
        try {
            ...
            Service.getReviews(product_id,getContext(), new RequestCallBack() {
                @Override
